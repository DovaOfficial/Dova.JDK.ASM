...
[JniSignatureAttribute("Lorg/objectweb/asm/Context;", "final")]
	...
	: Dova.JDK.java.lang.Object
{
	...
	static Context()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/Context;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "attributePrototypes", "[Lorg/objectweb/asm/Attribute;"));
		...
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "currentMethodLabels", "[Lorg/objectweb/asm/Label;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "currentTypeAnnotationTarget", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "currentTypeAnnotationTargetPath", "Lorg/objectweb/asm/TypePath;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "currentLocalVariableAnnotationRangeStarts", "[Lorg/objectweb/asm/Label;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "currentLocalVariableAnnotationRangeEnds", "[Lorg/objectweb/asm/Label;"));
	...
	public JavaArray<Dova.JDK.org.objectweb.asm.Attribute> attributePrototypes_Property
	{
		get
		{
	...
	public JavaArray<Dova.JDK.org.objectweb.asm.Label> currentMethodLabels_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/TypePath;", "")]
	public Dova.JDK.org.objectweb.asm.TypePath currentTypeAnnotationTargetPath_Property
	{
		get
		{
	...
	[JniSignatureAttribute("[Lorg/objectweb/asm/Label;", "")]
	public JavaArray<Dova.JDK.org.objectweb.asm.Label> currentLocalVariableAnnotationRangeStarts_Property
	{
		get
		{
	...
	[JniSignatureAttribute("[Lorg/objectweb/asm/Label;", "")]
	public JavaArray<Dova.JDK.org.objectweb.asm.Label> currentLocalVariableAnnotationRangeEnds_Property
	{
		get
		{
	...
	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/Context;";
