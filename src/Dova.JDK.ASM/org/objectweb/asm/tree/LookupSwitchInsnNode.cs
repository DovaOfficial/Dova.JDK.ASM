...
[JniSignatureAttribute("Lorg/objectweb/asm/tree/LookupSwitchInsnNode;", "public")]
	...
	: Dova.JDK.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/tree/LookupSwitchInsnNode;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "dflt", "Lorg/objectweb/asm/tree/LabelNode;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "keys", "Ljava/util/List;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "labels", "Ljava/util/List;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lorg/objectweb/asm/tree/LabelNode;[I[Lorg/objectweb/asm/tree/LabelNode;)V"));
	...
	public Dova.JDK.org.objectweb.asm.tree.LabelNode dflt_Property
	{
		get
		{
	...
	[JniSignatureAttribute("(Lorg/objectweb/asm/tree/LabelNode;[I[Lorg/objectweb/asm/tree/LabelNode;)V", "public")]
	public LookupSwitchInsnNode(Dova.JDK.org.objectweb.asm.tree.LabelNode arg0, JavaArray<int> arg1, JavaArray<Dova.JDK.org.objectweb.asm.tree.LabelNode> arg2) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/tree/LookupSwitchInsnNode;";
