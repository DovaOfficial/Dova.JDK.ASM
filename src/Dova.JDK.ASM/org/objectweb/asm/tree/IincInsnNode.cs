...
[JniSignatureAttribute("Lorg/objectweb/asm/tree/IincInsnNode;", "public")]
	...
	: Dova.JDK.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	static IincInsnNode()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/tree/IincInsnNode;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "var", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "incr", "I"));
	...
	public IincInsnNode(int arg0, int arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/tree/IincInsnNode;";
