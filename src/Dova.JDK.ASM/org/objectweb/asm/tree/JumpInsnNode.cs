...
[JniSignatureAttribute("Lorg/objectweb/asm/tree/JumpInsnNode;", "public")]
	...
	: Dova.JDK.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	static JumpInsnNode()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/tree/JumpInsnNode;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "label", "Lorg/objectweb/asm/tree/LabelNode;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(ILorg/objectweb/asm/tree/LabelNode;)V"));
	...
	public Dova.JDK.org.objectweb.asm.tree.LabelNode label_Property
	{
		get
		{
	...
	public JumpInsnNode(int arg0, Dova.JDK.org.objectweb.asm.tree.LabelNode arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/tree/JumpInsnNode;";
