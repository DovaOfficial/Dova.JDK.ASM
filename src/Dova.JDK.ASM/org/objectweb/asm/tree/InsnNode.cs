...
[JniSignatureAttribute("Lorg/objectweb/asm/tree/InsnNode;", "public")]
public partial class InsnNode
	: Dova.JDK.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	static InsnNode()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/tree/InsnNode;");
	...
	public InsnNode(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(I)V", "public")]
	public InsnNode(int arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/tree/InsnNode;";
