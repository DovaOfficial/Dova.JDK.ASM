...
[JniSignatureAttribute("Lorg/objectweb/asm/tree/LineNumberNode;", "public")]
public partial class LineNumberNode
	: Dova.JDK.org.objectweb.asm.tree.AbstractInsnNode
{
	...
	static LineNumberNode()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/tree/LineNumberNode;");
	...
	public LineNumberNode(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(ILorg/objectweb/asm/tree/LabelNode;)V", "public")]
	public LineNumberNode(int arg0, Dova.JDK.org.objectweb.asm.tree.LabelNode arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/tree/LineNumberNode;";
