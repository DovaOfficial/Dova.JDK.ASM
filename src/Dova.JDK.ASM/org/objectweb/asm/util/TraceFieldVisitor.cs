...
[JniSignatureAttribute("Lorg/objectweb/asm/util/TraceFieldVisitor;", "public final")]
	...
	: Dova.JDK.org.objectweb.asm.FieldVisitor
{
	...
	static TraceFieldVisitor()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/util/TraceFieldVisitor;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "p", "Lorg/objectweb/asm/util/Printer;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lorg/objectweb/asm/util/Printer;)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lorg/objectweb/asm/FieldVisitor;Lorg/objectweb/asm/util/Printer;)V"));
	...
	public Dova.JDK.org.objectweb.asm.util.Printer p_Property
	{
		get
		{
	...
	public TraceFieldVisitor(IntPtr currentRefPtr) : base(currentRefPtr)
	{
	}

	[JniSignatureAttribute("(Lorg/objectweb/asm/util/Printer;)V", "public")]
	public TraceFieldVisitor(Dova.JDK.org.objectweb.asm.util.Printer arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Lorg/objectweb/asm/FieldVisitor;Lorg/objectweb/asm/util/Printer;)V", "public")]
	public TraceFieldVisitor(Dova.JDK.org.objectweb.asm.FieldVisitor arg0, Dova.JDK.org.objectweb.asm.util.Printer arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/util/TraceFieldVisitor;";
