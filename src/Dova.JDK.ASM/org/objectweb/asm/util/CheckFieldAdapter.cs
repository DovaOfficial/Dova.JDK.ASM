...
[JniSignatureAttribute("Lorg/objectweb/asm/util/CheckFieldAdapter;", "public")]
	...
	: Dova.JDK.org.objectweb.asm.FieldVisitor
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/util/CheckFieldAdapter;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "visitEndCalled", "Z"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lorg/objectweb/asm/FieldVisitor;)V"));
	...
	[JniSignatureAttribute("(Lorg/objectweb/asm/FieldVisitor;)V", "public")]
	public CheckFieldAdapter(Dova.JDK.org.objectweb.asm.FieldVisitor arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(ILorg/objectweb/asm/FieldVisitor;)V", "protected")]
	public CheckFieldAdapter(int arg0, Dova.JDK.org.objectweb.asm.FieldVisitor arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/util/CheckFieldAdapter;";
