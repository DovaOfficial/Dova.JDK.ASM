...
[JniSignatureAttribute("Lorg/objectweb/asm/util/TraceMethodVisitor;", "public final")]
	...
	: Dova.JDK.org.objectweb.asm.MethodVisitor
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/util/TraceMethodVisitor;");
		...
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lorg/objectweb/asm/MethodVisitor;Lorg/objectweb/asm/util/Printer;)V"));
	...
	public TraceMethodVisitor(Dova.JDK.org.objectweb.asm.util.Printer arg0) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0))
	{
	}

	[JniSignatureAttribute("(Lorg/objectweb/asm/MethodVisitor;Lorg/objectweb/asm/util/Printer;)V", "public")]
	public TraceMethodVisitor(Dova.JDK.org.objectweb.asm.MethodVisitor arg0, Dova.JDK.org.objectweb.asm.util.Printer arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/util/TraceMethodVisitor;";
