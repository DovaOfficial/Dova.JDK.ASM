...
[JniSignatureAttribute("Lorg/objectweb/asm/ModuleVisitor;", "public abstract")]
	...
	: Dova.JDK.java.lang.Object
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/ModuleVisitor;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "api", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mv", "Lorg/objectweb/asm/ModuleVisitor;"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(I)V"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(ILorg/objectweb/asm/ModuleVisitor;)V"));
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/ModuleVisitor;", "protected")]
	public Dova.JDK.org.objectweb.asm.ModuleVisitor mv_Property
	{
		get
		{
	...
	[JniSignatureAttribute("(ILorg/objectweb/asm/ModuleVisitor;)V", "protected")]
	public ModuleVisitor(int arg0, Dova.JDK.org.objectweb.asm.ModuleVisitor arg1) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[1], arg0, arg1))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/ModuleVisitor;";
