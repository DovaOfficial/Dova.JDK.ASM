...
[JniSignatureAttribute("Lorg/objectweb/asm/TypeReference;", "public")]
	...
	: Dova.JDK.java.lang.Object
{
	...
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/TypeReference;");
		...
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "putTarget", "(ILorg/objectweb/asm/ByteVector;)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newFormalParameterReference", "(I)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newExceptionReference", "(I)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newTypeParameterReference", "(II)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newTypeParameterBoundReference", "(III)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newTryCatchReference", "(I)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newTypeArgumentReference", "(II)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newSuperTypeReference", "(I)Lorg/objectweb/asm/TypeReference;"));
		MethodPtrs.Add(DovaVM.Runtime.GetStaticMethodId(ClassPtr, "newTypeReference", "(I)Lorg/objectweb/asm/TypeReference;"));
	...
	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/TypeReference;";
	...
	[JniSignatureAttribute("(ILorg/objectweb/asm/ByteVector;)V", "static")]
	public static void putTarget(int arg0, Dova.JDK.org.objectweb.asm.ByteVector arg1)
	{
		DovaVM.Runtime.CallStaticVoidMethodA(ClassRefPtr, MethodPtrs[2], arg0, arg1);
	}

	[JniSignatureAttribute("(I)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newFormalParameterReference(int arg0)
	{
		var ret = DovaVM.Runtime.CallStaticObjectMethodA(ClassRefPtr, MethodPtrs[3], arg0);
		return DovaInterfaceFactory.Get<Dova.JDK.org.objectweb.asm.TypeReference>(ret);
	}

	[JniSignatureAttribute("(I)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newExceptionReference(int arg0)
	{
		var ret = DovaVM.Runtime.CallStaticObjectMethodA(ClassRefPtr, MethodPtrs[4], arg0);
		return DovaInterfaceFactory.Get<Dova.JDK.org.objectweb.asm.TypeReference>(ret);
	}

	[JniSignatureAttribute("(II)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newTypeParameterReference(int arg0, int arg1)
	{
		var ret = DovaVM.Runtime.CallStaticObjectMethodA(ClassRefPtr, MethodPtrs[5], arg0, arg1);
		return DovaInterfaceFactory.Get<Dova.JDK.org.objectweb.asm.TypeReference>(ret);
	}

	[JniSignatureAttribute("(III)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newTypeParameterBoundReference(int arg0, int arg1, int arg2)
	{
	...
	[JniSignatureAttribute("(I)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newTryCatchReference(int arg0)
	{
	...
	[JniSignatureAttribute("(II)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newTypeArgumentReference(int arg0, int arg1)
	{
	...
	[JniSignatureAttribute("(I)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newSuperTypeReference(int arg0)
	{
	...
	[JniSignatureAttribute("(I)Lorg/objectweb/asm/TypeReference;", "public static")]
	public static Dova.JDK.org.objectweb.asm.TypeReference newTypeReference(int arg0)
	{
