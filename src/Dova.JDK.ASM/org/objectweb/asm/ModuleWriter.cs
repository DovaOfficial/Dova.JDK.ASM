...
[JniSignatureAttribute("Lorg/objectweb/asm/ModuleWriter;", "final")]
	...
	: Dova.JDK.org.objectweb.asm.ModuleVisitor
{
	...
	static ModuleWriter()
	{
		ClassPtr = DovaVM.Runtime.FindClass("Lorg/objectweb/asm/ModuleWriter;");
		ClassRefPtr = DovaVM.Runtime.NewGlobalRef(ClassPtr);
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "symbolTable", "Lorg/objectweb/asm/SymbolTable;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "moduleNameIndex", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "moduleFlags", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "moduleVersionIndex", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "requiresCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "requires", "Lorg/objectweb/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "exportsCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "exports", "Lorg/objectweb/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "opensCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "opens", "Lorg/objectweb/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "usesCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "usesIndex", "Lorg/objectweb/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "providesCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "provides", "Lorg/objectweb/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "packageCount", "I"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "packageIndex", "Lorg/objectweb/asm/ByteVector;"));
		FieldPtrs.Add(DovaVM.Runtime.GetFieldId(ClassPtr, "mainClassIndex", "I"));
		ConstructorPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "<init>", "(Lorg/objectweb/asm/SymbolTable;III)V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "visitEnd", "()V"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "computeAttributesSize", "()I"));
		MethodPtrs.Add(DovaVM.Runtime.GetMethodId(ClassPtr, "putAttributes", "(Lorg/objectweb/asm/ByteVector;)V"));
	...
	public Dova.JDK.org.objectweb.asm.ByteVector requires_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/ByteVector;", "private final")]
	public Dova.JDK.org.objectweb.asm.ByteVector exports_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/ByteVector;", "private final")]
	public Dova.JDK.org.objectweb.asm.ByteVector opens_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/ByteVector;", "private final")]
	public Dova.JDK.org.objectweb.asm.ByteVector usesIndex_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/ByteVector;", "private final")]
	public Dova.JDK.org.objectweb.asm.ByteVector provides_Property
	{
		get
		{
	...
	[JniSignatureAttribute("Lorg/objectweb/asm/ByteVector;", "private final")]
	public Dova.JDK.org.objectweb.asm.ByteVector packageIndex_Property
	{
		get
		{
	...
	[JniSignatureAttribute("(Lorg/objectweb/asm/SymbolTable;III)V", "")]
	public ModuleWriter(Dova.JDK.org.objectweb.asm.SymbolTable arg0, int arg1, int arg2, int arg3) : base(DovaVM.Runtime.NewObjectA(ClassPtr, ConstructorPtrs[0], arg0, arg1, arg2, arg3))
	{
	}

	public override string GetJavaClassSignature() => "Lorg/objectweb/asm/ModuleWriter;";
	...
	public void putAttributes(Dova.JDK.org.objectweb.asm.ByteVector arg0)
	{
